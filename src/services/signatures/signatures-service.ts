...
import {
  SignaturesListRequest,
  signaturesListRequestRequest,
} from './models/signatures-list-request';
import {
  SignaturesCreateRequest,
  signaturesCreateRequestRequest,
} from './models/signatures-create-request';

/**
 * Service class for SignaturesService operations.
 * Provides methods to interact with SignaturesService-related API endpoints.
...
export class SignaturesService extends BaseService {
   ...
   */
  async list(body: SignaturesListRequest, requestConfig?: Partial<SdkConfig>): Promise<any> {
    ...
    const request = new RequestBuilder()
      ...
      .setRequestSchema(signaturesListRequestRequest)
  ...
  async create(
    ...
    const request = new RequestBuilder()
      ...
      .setRequestSchema(signaturesCreateRequestRequest)
      .addAccessTokenAuth(resolvedConfig?.token, 'Bearer')
      .setRequestContentType(ContentType.MultipartFormData)
      .addResponse({
        schema: z.any(),
