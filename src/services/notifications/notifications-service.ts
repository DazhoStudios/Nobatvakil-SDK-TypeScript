...
import {
  ...
  notificationsUpdateRequestRequest,
} from './models/notifications-update-request';
...
export class NotificationsService extends BaseService {
   ...
   * @returns {Promise<HttpResponse<any>>} - OK
   */
  async update(body: NotificationsUpdateRequest, requestConfig?: Partial<SdkConfig>): Promise<any> {
    ...
    const request = new RequestBuilder()
      ...
      .setRequestSchema(notificationsUpdateRequestRequest)
      .addAccessTokenAuth(resolvedConfig?.token, 'Bearer')
