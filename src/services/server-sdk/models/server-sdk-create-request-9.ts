...
/**
 * Zod schema for the ServerSdkCreateRequest9 model.
 * Defines the structure and validation rules for this data type.
 * This is the shape used in application code - what developers interact with.
 */
export const serverSdkCreateRequest9 = z.lazy(() => {
  return z.object({
...
/**
 * @typedef {ServerSdkCreateRequest9} serverSdkCreateRequest9
 ...
 * @property {string} licenseLevel
 * @property {string} issuingAuthority
 * @property {string} type
 */
export type ServerSdkCreateRequest9 = z.infer<typeof serverSdkCreateRequest9>;

/**
 * Zod schema for mapping API responses to the ServerSdkCreateRequest9 application shape.
 * Handles any property name transformations from the API schema.
 * If property names match the API schema exactly, this is identical to the application shape.
 */
export const serverSdkCreateRequest9Response = z.lazy(() => {
  return z
    .object({
...
/**
 * Zod schema for mapping the ServerSdkCreateRequest9 application shape to API requests.
 * Handles any property name transformations required by the API schema.
 * If property names match the API schema exactly, this is identical to the application shape.
 */
export const serverSdkCreateRequest9Request = z.lazy(() => {
  return z
    .object({
      firstName: z.string().optional().nullable(),
      lastName: z.string().optional().nullable(),
