...
import {
  ...
  lawyerDashboardSettingsNotificationsUpdateRequestRequest,
} from './models/lawyer-dashboard-settings-notifications-update-request';

/**
 * Service class for LawyerDashboardSettingsNotificationsService operations.
 * Provides methods to interact with LawyerDashboardSettingsNotificationsService-related API endpoints.
 * All methods return promises and handle request/response serialization automatically.
 */
export class LawyerDashboardSettingsNotificationsService extends BaseService {
   ...
   */
  async update(
    body: LawyerDashboardSettingsNotificationsUpdateRequest,
    ...
    const request = new RequestBuilder()
      ...
      .setRequestSchema(lawyerDashboardSettingsNotificationsUpdateRequestRequest)
      .addAccessTokenAuth(resolvedConfig?.token, 'Bearer')
