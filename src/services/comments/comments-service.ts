...
import {
  ...
  commentsRemoveRequestRequest,
} from './models/comments-remove-request';
...
export class CommentsService extends BaseService {
   ...
   * @returns {Promise<HttpResponse<any>>} - OK
   */
  async remove(body: CommentsRemoveRequest, requestConfig?: Partial<SdkConfig>): Promise<any> {
    ...
    const request = new RequestBuilder()
      ...
      .setRequestSchema(commentsRemoveRequestRequest)
      .addAccessTokenAuth(resolvedConfig?.token, 'Bearer')
