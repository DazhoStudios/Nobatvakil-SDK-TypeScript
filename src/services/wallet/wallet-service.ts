...
import { WalletAddRequest, walletAddRequestRequest } from './models/wallet-add-request';
...
export class WalletService extends BaseService {
   ...
   * @returns {Promise<HttpResponse<any>>} - OK
   */
  async add(body: WalletAddRequest, requestConfig?: Partial<SdkConfig>): Promise<any> {
    ...
    const request = new RequestBuilder()
      ...
      .setRequestSchema(walletAddRequestRequest)
      .addAccessTokenAuth(resolvedConfig?.token, 'Bearer')
