...
/**
 * Service class for SeoPagesService operations.
 * Provides methods to interact with SeoPagesService-related API endpoints.
 * All methods return promises and handle request/response serialization automatically.
 */
export class SeoPagesService extends BaseService {
